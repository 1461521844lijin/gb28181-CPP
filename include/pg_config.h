...
#define CONFIGURE_ARGS " '--disable-shared' '--enable-static' '--prefix=/' '--bindir=${prefix}/bin' '--sbindir=${prefix}/bin' '--libdir=${prefix}/lib' '--includedir=${prefix}/include' '--oldincludedir=${prefix}/include' '--without-readline' '--without-zlib' '--without-openssl' 'CC=/usr/bin/gcc' 'CFLAGS= -m64 -fPIC -O3' 'LDFLAGS= -m64' 'LIBS=' 'CPPFLAGS= -DNDEBUG' 'CXX=/usr/bin/g++' 'CXXFLAGS= -m64 -fPIC -O3' 'PKG_CONFIG_PATH=/home/conan/w/prod/BuildSingleReference/.conan/data/libpq/14.5/_/_/build/1d877a3df840030e6a8abb74c5ffb9088d08b47a/build-release/conan:'"
...
#define PG_VERSION_STR "PostgreSQL 14.5 on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 8.4.0-1ubuntu1~18.04) 8.4.0, 64-bit"
