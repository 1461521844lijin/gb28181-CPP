...
public:
    ...
    InviteRequest(Device::ptr device, const std::string &channelId, REQ_MESSAGE_TYPE reqtype = REQ_CALL_INVITE)
        : BaseRequest(reqtype), m_device(device), m_channel_id(channelId) {}
