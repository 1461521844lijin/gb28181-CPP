...
public:
    ...
    PresetCtlRequest(Device::ptr device, std::string channelId, int byte4, int byte5, int byte6, int byte7)
        : MessageRequest(device, REQ_MESSAGE_TYPE::DEVICE_CONTROL_PRESET),
          m_byte4(byte4),
          m_byte5(byte5),
          m_byte6(byte6),
          m_byte7(byte7),
