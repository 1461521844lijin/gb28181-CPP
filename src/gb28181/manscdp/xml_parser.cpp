...
int XmlParser::parse_cmdcategory(tinyxml_ele_t *ele, manscdp_cmd_category_e &category, string &name)
{
...
int XmlParser::parse_cmdtype(tinyxml_ele_t *ele, manscdp_msgbody_header_t &bh, string &textstr)
{
...
int XmlParser::ParseEleStr(tinyxml_ele_t *ele, const char *name, string &textstr, bool brequired, bool bto_utf8)
{
...
int XmlParser::ParseEleInt(tinyxml_ele_t *ele, const char *name, int &value, bool brequired)
{
    tinyxml_ele_t* child_ele = ele->FirstChildElement(name);
    if (nullptr == child_ele) {
        if (brequired) {
...
int XmlParser::parse_ele_double(tinyxml_ele_t *ele, const char *name, double &value, bool brequired)
{
    tinyxml_ele_t* child_ele = ele->FirstChildElement(name);
    if (nullptr == child_ele) {
        if (brequired) {
...
bool XmlParser::is_member(tinyxml_ele_t *ele, const char *name)
{
